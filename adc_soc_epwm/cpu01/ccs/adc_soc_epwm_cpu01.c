...
//			pid1_iq.OutMax=VdcLink;
//			pid1_iq.OutMin=-VdcLink;
//
//			pid1_id.Kp = My_id_Kp;
//			pid1_id.Ki = My_id_Ki*T;
//			pid1_id.OutMax=VdcLink;
//			pid1_id.OutMin=-VdcLink;
//
//			pid1_ix.Kp = My_ix_Kp;
...
__interrupt void epwm9_isr(void)
{
	...
	Ia[1] = (AdcaResultRegs.ADCRESULT2 - AdcResult_Ia_0A)*0.0109463;
	Ia[2] = (AdcaResultRegs.ADCRESULT4 - AdcResult_Ia_0A)*0.0109463;
	Ia[3] = (AdcaResultRegs.ADCRESULT6 - AdcResult_Ia_0A)*0.0109463;
	Ia[4] = (AdcaResultRegs.ADCRESULT8 - AdcResult_Ia_0A)*0.0109463;
	Ia[5] = (AdcaResultRegs.ADCRESULT10 - AdcResult_Ia_0A)*0.0109463;

	Ib[1] = (AdcaResultRegs.ADCRESULT3 - AdcResult_Ib_0A)*0.0106662;
	Ib[2] = (AdcaResultRegs.ADCRESULT5 - AdcResult_Ib_0A)*0.0106662;
	Ib[3] = (AdcaResultRegs.ADCRESULT7 - AdcResult_Ib_0A)*0.0106662;
	Ib[4] = (AdcaResultRegs.ADCRESULT9 - AdcResult_Ib_0A)*0.0106662;
	Ib[5] = (AdcaResultRegs.ADCRESULT11 - AdcResult_Ib_0A)*0.0106662;

	Ic[1] = (AdcbResultRegs.ADCRESULT3 - AdcResult_Ic_0A)*0.0106465;
	Ic[2] = (AdcbResultRegs.ADCRESULT5 - AdcResult_Ic_0A)*0.0106465;
	Ic[3] = (AdcbResultRegs.ADCRESULT7 - AdcResult_Ic_0A)*0.0106465;
	Ic[4] = (AdcbResultRegs.ADCRESULT9 - AdcResult_Ic_0A)*0.0106465;
	Ic[5] = (AdcbResultRegs.ADCRESULT11 - AdcResult_Ic_0A)*0.0106465;

	Id[1] = (AdcbResultRegs.ADCRESULT2 - AdcResult_Id_0A)*0.0106635;
	Id[2] = (AdcbResultRegs.ADCRESULT4 - AdcResult_Id_0A)*0.0106635;
	Id[3] = (AdcbResultRegs.ADCRESULT6 - AdcResult_Id_0A)*0.0106635;
	Id[4] = (AdcbResultRegs.ADCRESULT8 - AdcResult_Id_0A)*0.0106635;
	Id[5] = (AdcbResultRegs.ADCRESULT10 - AdcResult_Id_0A)*0.0106635;

	Ie[1] = (AdccResultRegs.ADCRESULT3 - AdcResult_Ie_0A)*0.0107135;
	Ie[2] = (AdccResultRegs.ADCRESULT5 - AdcResult_Ie_0A)*0.0107135;
	Ie[3] = (AdccResultRegs.ADCRESULT7 - AdcResult_Ie_0A)*0.0107135;
	Ie[4] = (AdccResultRegs.ADCRESULT9 - AdcResult_Ie_0A)*0.0107135;
	Ie[5] = (AdccResultRegs.ADCRESULT11 - AdcResult_Ie_0A)*0.0107135;

	If[1] = (AdccResultRegs.ADCRESULT2 - AdcResult_If_0A)*0.0106537;
	If[2] = (AdccResultRegs.ADCRESULT4 - AdcResult_If_0A)*0.0106537;
	If[3] = (AdccResultRegs.ADCRESULT6 - AdcResult_If_0A)*0.0106537;
	If[4] = (AdccResultRegs.ADCRESULT8 - AdcResult_If_0A)*0.0106537;
	If[5] = (AdccResultRegs.ADCRESULT10 - AdcResult_If_0A)*0.0106537;
...
void StartADC_One_Conversion_SixPhase(void)
{
	...
	if(ADC_0V_adjust_done==0) //只在开机前，校对0电流的ADC值，一旦开机后，不管停止否，不再进行校对
	{
		...
		if(ADC_0V_adjust_start==1) //2秒内，先求10万次的和，然后再求平均
		{
				...
				AdcResult_Ic_0A = AdcResult_Ic_0A + (AdcbResultRegs.ADCRESULT1);
				AdcResult_Id_0A = AdcResult_Id_0A + (AdcbResultRegs.ADCRESULT0);
				AdcResult_Ie_0A = AdcResult_Ie_0A + (AdccResultRegs.ADCRESULT1);
				AdcResult_If_0A = AdcResult_If_0A + (AdccResultRegs.ADCRESULT0);

			if(++ADC_adj_num == 100000) //10秒内，先求10万次的和，然后再求平均
			{
				ADC_0V_adjust_start = 0;
				ADC_0V_adjust_done = 1;
				AdcResult_Ia_0A = 0.00001*AdcResult_Ia_0A;
				AdcResult_Ib_0A = 0.00001*AdcResult_Ib_0A;
				AdcResult_Ic_0A = 0.00001*AdcResult_Ic_0A;
				AdcResult_Id_0A = 0.00001*AdcResult_Id_0A;
				AdcResult_Ie_0A = 0.00001*AdcResult_Ie_0A;
				AdcResult_If_0A = 0.00001*AdcResult_If_0A;
	...
	Ic[0] = (AdcbResultRegs.ADCRESULT1 - AdcResult_Ic_0A)*0.0098922 ; // Ic=0,采样值=2066.95, 1/51.269=0.019504964
	Id[0] = (AdcbResultRegs.ADCRESULT0 - AdcResult_Id_0A)*0.0099147; // Id=0,采样值=2064.13, 1/51.269=0.019504964
	Ie[0] = (AdccResultRegs.ADCRESULT1 - AdcResult_Ie_0A)*0.0099611; // Ie=0,采样值=2060.02, 1/51.269=0.019504964
	If[0] = (AdccResultRegs.ADCRESULT0 - AdcResult_If_0A)*0.0099172; // If=0,采样值=2068.47, 1/51.269=0.019504964


	 if (AdcdResult2_VdcLink>0)
		 {
			 VdcLink = 0.0585897 * AdcdResult2_VdcLink + 1.0306929;
		 }
...
//***********************************Ia/Ib ADCA2/A3**********************************//
    ...
    AdcaRegs.ADCSOC2CTL.bit.CHSEL = 2;  //SOC1 will convert pin A2 for Ia
    ...
    AdcaRegs.ADCSOC4CTL.bit.CHSEL = 2;  //SOC2 will convert pin A2 for Ia
    ...
    AdcaRegs.ADCSOC6CTL.bit.CHSEL = 2;  //SOC3 will convert pin A2 for Ia
    ...
    AdcaRegs.ADCSOC8CTL.bit.CHSEL = 2;  //SOC4 will convert pin A2 for Ia
    ...
    AdcaRegs.ADCSOC10CTL.bit.CHSEL = 2;  //SOC5 will convert pin A2 for Ia
    ...
    //**************Ib_ADCA3************//
    AdcaRegs.ADCSOC1CTL.bit.CHSEL = 3;  //SOC6 will convert pin A3 for Ib
    ...
    AdcaRegs.ADCSOC3CTL.bit.CHSEL = 3;  //SOC7 will convert pin A3 for Ib
    ...
    AdcaRegs.ADCSOC5CTL.bit.CHSEL = 3;  //SOC8 will convert pin A3 for Ib
    ...
    AdcaRegs.ADCSOC7CTL.bit.CHSEL = 3;  //SOC9 will convert pin A3 for Ib
    ...
    AdcaRegs.ADCSOC9CTL.bit.CHSEL = 3;  //SOC10 will convert pin A3 for Ib
...
//**********************************Id/Ic ADCB2/B0*********************************************//
    //*************Id_ADCB2***************//
    AdcbRegs.ADCSOC0CTL.bit.CHSEL = 2;  //SOC0 will convert pin B2 for Id
    ...
    AdcbRegs.ADCSOC2CTL.bit.CHSEL = 2;  //SOC1 will convert pin B2 for Id
    ...
    AdcbRegs.ADCSOC4CTL.bit.CHSEL = 2;  //SOC2 will convert pin B2 for Id
    ...
    AdcbRegs.ADCSOC6CTL.bit.CHSEL = 2;  //SOC3 will convert pin B2 for Id
    ...
    AdcbRegs.ADCSOC8CTL.bit.CHSEL = 2;  //SOC4 will convert pin B2 for Id
    ...
    AdcbRegs.ADCSOC10CTL.bit.CHSEL = 2;  //SOC5 will convert pin B2 for Id
    ...
    //**************Ic_ADCB0************//
    AdcbRegs.ADCSOC1CTL.bit.CHSEL = 0;  //SOC6 will convert pin B0 for Ic
    ...
    AdcbRegs.ADCSOC3CTL.bit.CHSEL = 0;  //SOC7 will convert pin B0 for Ic
    ...
    AdcbRegs.ADCSOC5CTL.bit.CHSEL = 0;  //SOC8 will convert pin B0 for Ic
    ...
    AdcbRegs.ADCSOC7CTL.bit.CHSEL = 0;  //SOC9 will convert pin B0 for Ic
    ...
    AdcbRegs.ADCSOC9CTL.bit.CHSEL = 0;  //SOC10 will convert pin B0 for Ic
    ...
    AdcbRegs.ADCSOC11CTL.bit.CHSEL = 0;  //SOC11 will convert pin B0 for Ic
...
//************************************If/Ie ADCC4/C3************************************************//
    //*************If_ADCC4***************//
    AdccRegs.ADCSOC0CTL.bit.CHSEL = 4;  //SOC0 will convert pin C4 for If
    AdcaRegs.ADCSOC0CTL.bit.ACQPS = acqps; //sample window is acqps + 1 SYSCLK cycles
    AdcaRegs.ADCSOC0CTL.bit.TRIGSEL = 0x0F;  //TRIGSEL = 0x0Fh ADCTRIG15 - ePWM6, ADCSOCA

    AdccRegs.ADCSOC2CTL.bit.CHSEL = 4;  //SOC1 will convert pin C4 for If
    ...
    AdccRegs.ADCSOC4CTL.bit.CHSEL = 4;  //SOC2 will convert pin C4 for If
    ...
    AdccRegs.ADCSOC6CTL.bit.CHSEL = 4;  //SOC3 will convert pin C4 for If
    ...
    AdccRegs.ADCSOC8CTL.bit.CHSEL = 4;  //SOC4 will convert pin C4 for If
    AdccRegs.ADCSOC8CTL.bit.ACQPS = acqps; //sample window is acqps + 1 SYSCLK cycles
    AdccRegs.ADCSOC8CTL.bit.TRIGSEL = 0x13;  //TRIGSEL = 0x13h ADCTRIG20 - ePWM8, ADCSOCA

    AdccRegs.ADCSOC10CTL.bit.CHSEL = 4;  //SOC5 will convert pin C4 for If
    ...
    //*************Ie_ADCC3***************//
    AdccRegs.ADCSOC1CTL.bit.CHSEL = 3;  //SOC6 will convert pin C3 for Ie
    AdccRegs.ADCSOC1CTL.bit.ACQPS = acqps; //sample window is acqps + 1 SYSCLK cycles
    AdccRegs.ADCSOC1CTL.bit.TRIGSEL = 0xF;  //TRIGSEL = 0xFh ADCTRIG15 - ePWM6, ADCSOCA

    AdccRegs.ADCSOC3CTL.bit.CHSEL = 3;  //SOC7 will convert pin C3 for Ie
    ...
    AdccRegs.ADCSOC5CTL.bit.CHSEL = 3;  //SOC8 will convert pin C3 for Ie
    ...
    AdccRegs.ADCSOC7CTL.bit.CHSEL = 3;  //SOC9 will convert pin C3 for Ie
    ...
    AdccRegs.ADCSOC9CTL.bit.CHSEL = 3;  //SOC10 will convert pin C3 for Ie
    AdccRegs.ADCSOC9CTL.bit.ACQPS = acqps; //sample window is acqps + 1 SYSCLK cycles
    AdccRegs.ADCSOC9CTL.bit.TRIGSEL = 0x13;  //TRIGSEL = 0x13h ADCTRIG19 - ePWM8, ADCSOCA

    AdccRegs.ADCSOC11CTL.bit.CHSEL = 3;  //SOC11 will convert pin C3 for Ie
    ...
    AdccRegs.ADCINTSEL1N2.bit.INT1SEL = 11; //end of SOC0 will set INT1 flag
    AdccRegs.ADCINTSEL1N2.bit.INT1E = 1;   //enable INT1 flag
    AdccRegs.ADCINTFLGCLR.bit.ADCINT1 = 1; //make sure INT1 flag is cleared

    AdccRegs.ADCINTSEL1N2.bit.INT2SEL = 6; //end of SOC0 will set INT2 flag
