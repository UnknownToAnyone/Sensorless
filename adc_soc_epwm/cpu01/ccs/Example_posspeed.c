...
void  POSSPEED_Init(void)
{
    ...
    EQep2Regs.QEPCTL.bit.PCRM=1;       // PCRM=00 mode - QPOSCNT reset on index event
    ...
    EQep2Regs.QCAPCTL.bit.UPPS=5;       // 1/32 for unit positio n
...
//**** Position calculation - mechanical and electrical motor angle  ****//
     p->DirectionQep = EQep2Regs.QEPSTS.bit.QDF;    // Motor direction: 0=CCW/reverse, 1=CW/forward

     pos16bval=(unsigned int)EQep2Regs.QPOSCNT;     // capture position once per QA/QB period
     ...
     // where mech_scaler = 10000 cnts/revolution
...
// Unit Timer is configured for 100Hz in INIT function
    ...
    {
        /** Differentiator  **/
        // The following lines calculate position = (x2-x1)/10000 (position in 1 revolution)
