...
// This function is found in F2837xD_PieVect.c.
    ...
    EALLOW;
    	PieVectTable.XINT1_INT = &xint1_isr_synchronous_PWM;
    ...
    //GPIO_SetupXINT3Gpio(71);  //Gpio70 is set as the Synchronous signal for CUP2's EPWMs
...
Uint16 *CPU1TOCPU2RAM_addr =(Uint16 *) 0x00003FC00;

Uint32 receive_CompAB_num = 0;
Uint32 receive_CompAB_cmd = 0;

Uint16 receive_CompAB[10];
Uint16 loop_i;
...
__interrupt void CPU01toCPU02IPC0IntHandler (void)
{
    ...
    IpcRegs.IPCSET.bit.IPC4 = 1; // tell the CPU01 that CPU02 has received the data from CUP01

    receive_CompAB_num = IpcRegs.IPCRECVDATA;
    receive_CompAB_cmd = IpcRegs.IPCRECVCOM;
    //*receive_CompAB_addr = IpcRegs.IPCRECVADDR;
    //receive_CompAB_addr = (void *)0x0003FC00;

    for(loop_i=0;loop_i<receive_CompAB_num;++loop_i)
    {
    	receive_CompAB[loop_i] =*((Uint16 *)(CPU1TOCPU2RAM_addr + loop_i));
    }
...
Uint16 change_compAB = 0;

__interrupt void epwm1_isr(void)
{
    // Update the CMPA and CMPB values
    //update_compare(&epwm1_info);
	switch(change_compAB)
	{
	case 1:
		EPWM1_CMPA = receive_CompAB[0];
		EPWM1_CMPB = receive_CompAB[4];
		break;
	case 2:
		EPWM1_CMPA = receive_CompAB[1];
		EPWM1_CMPB = receive_CompAB[5];
		break;
	case 3:
		EPWM1_CMPA = receive_CompAB[2];
		EPWM1_CMPB = receive_CompAB[6];
		break;
	case 4:
		EPWM1_CMPA = receive_CompAB[3];
		EPWM1_CMPB = receive_CompAB[7];
		break;
	default :
		EPWM1_CMPA = 1000;
		EPWM1_CMPB = 2000;
